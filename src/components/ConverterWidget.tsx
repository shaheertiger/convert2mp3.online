...
const translations: Record<string, Record<string, string>> = {
    en: {
        placeholder: 'Paste Spotify or SoundCloud link here...',
        start: 'Start',
        processing: 'Analyzing Track...',
    ...
    de: {
        placeholder: 'Spotify-Link hier einfügen...',
        start: 'Starten',
        processing: 'Track wird analysiert...',
    ...
    fr: {
        placeholder: 'Collez le lien Spotify ici...',
        start: 'Démarrer',
        processing: 'Analyse de la piste...',
    ...
    it: {
        placeholder: 'Incolla qui il link Spotify...',
        start: 'Convertire',
        processing: 'Analisi...',
    ...
    nl: { placeholder: 'Plak hier de Spotify-link...', start: 'Starten', processing: 'Track analyseren...', downloadMp3: 'Download MP3', downloadMp4: 'Download MP4', paste: 'Plakken', quality: 'Kwaliteit', std: 'Standaard', hd: 'Hoge Kwaliteit' },
    pl: { placeholder: 'Wklej link do Spotify tutaj...', start: 'Start', processing: 'Analizowanie utworu...', downloadMp3: 'Pobierz MP3', downloadMp4: 'Pobierz MP4', paste: 'Wklej', quality: 'Jakość', std: 'Standard', hd: 'Wysoka Jakość' },
    ru: { placeholder: 'Вставьте ссылку Spotify сюда...', start: 'Начать', processing: 'Анализ трека...', downloadMp3: 'Скачать MP3', downloadMp4: 'Скачать MP4', paste: 'Вставить', quality: 'Качество', std: 'Стандарт', hd: 'Высокое' },
    ua: { placeholder: 'Вставте посилання Spotify сюди...', start: 'Почати', processing: 'Аналіз треку...', downloadMp3: 'Завантажити MP3', downloadMp4: 'Завантажити MP4', paste: 'Вставити', quality: 'Якість', std: 'Стандарт', hd: 'Висока' },
    ro: { placeholder: 'Lipiți linkul Spotify aici...', start: 'Start', processing: 'Analizare piesă...', downloadMp3: 'Descarcă MP3', downloadMp4: 'Descarcă MP4', paste: 'Lipește', quality: 'Calitate', std: 'Standard', hd: 'Înaltă Calitate' },
    hu: { placeholder: 'Illessze be a Spotify linket...', start: 'Indítás', processing: 'Szám elemzése...', downloadMp3: 'MP3 letöltése', downloadMp4: 'MP4 letöltése', paste: 'Beillesztés', quality: 'Minőség', std: 'Normál', hd: 'Kiváló' },
    el: { placeholder: 'Επικολλήστε το σύνδεσμο Spotify...', start: 'Έναρξη', processing: 'Ανάλυση κομματιού...', downloadMp3: 'Λήψη MP3', downloadMp4: 'Λήψη MP4', paste: 'Επικόλληση', quality: 'Ποιότητα', std: 'Τυπική', hd: 'Υψηλή' },
    cz: { placeholder: 'Vložte odkaz na Spotify...', start: 'Start', processing: 'Analýza skladby...', downloadMp3: 'Stáhnout MP3', downloadMp4: 'Stáhnout MP4', paste: 'Vložit', quality: 'Kvalita', std: 'Standard', hd: 'Vysoká' },
    tr: { placeholder: 'Spotify bağlantısını buraya yapıştırın...', start: 'Başlat', processing: 'Parça analiz ediliyor...', downloadMp3: 'MP3 İndir', downloadMp4: 'MP4 İndir', paste: 'Yapıştır', quality: 'Kalite', std: 'Standart', hd: 'Yüksek' },
    id: { placeholder: 'Tempel tautan Spotify di sini...', start: 'Mulai', processing: 'Menganalisis Lagu...', downloadMp3: 'Unduh MP3', downloadMp4: 'Unduh MP4', paste: 'Tempel', quality: 'Kualitas', std: 'Standar', hd: 'Tinggi' },
    ph: { placeholder: 'I-paste ang link ng Spotify dito...', start: 'Simulan', processing: 'Sinusuri ang Kanta...', downloadMp3: 'I-download ang MP3', downloadMp4: 'I-download ang MP4', paste: 'I-paste', quality: 'Kalidad', std: 'Karaniwan', hd: 'Mataas' },
    th: { placeholder: 'วางลิงก์ Spotify ที่นี่...', start: 'เริ่ม', processing: 'กำลังวิเคราะห์เพลง...', downloadMp3: 'ดาวน์โหลด MP3', downloadMp4: 'ดาวน์โหลด MP4', paste: 'วาง', quality: 'คุณภาพ', std: 'มาตรฐาน', hd: 'สูง' },
    vi: { placeholder: 'Dán liên kết Spotify tại đây...', start: 'Bắt đầu', processing: 'Đang phân tích bài hát...', downloadMp3: 'Tải xuống MP3', downloadMp4: 'Tải xuống MP4', paste: 'Dán', quality: 'Chất lượng', std: 'Tiêu chuẩn', hd: 'Cao' },
    ko: { placeholder: 'Spotify 링크를 여기에 붙여넣기...', start: '시작', processing: '트랙 분석 중...', downloadMp3: 'MP3 다운로드', downloadMp4: 'MP4 다운로드', paste: '붙여넣기', quality: '품질', std: '표준', hd: '고화질' },
    ar: { placeholder: 'الصق رابط Spotify هنا...', start: 'ابدأ', processing: 'جاري تحليل المسار...', downloadMp3: 'تحميل MP3', downloadMp4: 'تحميل MP4', paste: 'لصق', quality: 'جودة', std: 'قياسي', hd: 'عالية' },
    jp: { placeholder: 'Spotifyリンクをここに貼り付け...', start: '開始', processing: 'トラックを分析中...', downloadMp3: 'MP3をダウンロード', downloadMp4: 'MP4をダウンロード', paste: '貼り付け', quality: '品質', std: '標準', hd: '高画質' },
    cn: { placeholder: '在此粘贴 Spotify 链接...', start: '开始', processing: '正在分析曲目...', downloadMp3: '下载 MP3', downloadMp4: '下载 MP4', paste: '粘贴', quality: '质量', std: '标准', hd: '高清' },
};
